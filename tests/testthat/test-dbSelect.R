test_that("database has been defined and dbSelect function works", {
  ...
  base_path <- app_sys("..")
  if (stringr::str_detect(base_path, ".Rcheck")) base_path <- file.path(base_path, "00_pkg_src/riskassessment")
  #if (stringr::str_detect(base_path, ".Rcheck")) base_path <- file.path(base_path, "../risk_assessment")
  cat("\n", base_path, "\n")
