...
Validation can serve as an umbrella for various terms, and admittedly, companies will diverge on what may be the "correct approach". The validation approach `rismetric` deverlopers followed is based on the philosophy of the [white paper](https://www.pharmar.org/white-paper/) published by the R Validation Hub. Thus, the scope of these risk-based tools are only intended to support validation decision making from that view point. The robustness and reliability of any software may (and likely will) require deeper inspection.
...
If you want a quick overview of the project and demo of the application, you should watch this video walk through on YouTube [from Shiny Conf 2023](https://bit.ly/raa_shinyconf23). At the conference, `riskassessment` was voted "best application" in the shiny showcase by conference attendees!
...
After this step is complete, you can simply run the contents of `app.R` to launch and/or deploy the application! For more information on our dev philosophy as it pertains to package management, please read the ["Using `renv`"](https://pharmar.github.io/riskassessment/articles/dev_renv.html) article.
...
We're constantly improving the app and it's documentation. Please explore the user guides that have been developed to date, available on the `riskassessment` [documentation site](https://bit.ly/raa_docs). Be sure to read the ['Get Started'](https://pharmar.github.io/riskassessment/articles/riskassessment.html) tab and perhaps [an article or two](https://pharmar.github.io/riskassessment/articles/index.html)!
