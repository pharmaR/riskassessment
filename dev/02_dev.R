...
usethis::use_data_raw( name = "community", open = TRUE ) 
usethis::use_data_raw( name = "maintenance", open = TRUE ) 
usethis::use_data_raw( name = "upload_format", open = TRUE )
usethis::use_data_raw( name = "testing", open = TRUE )
