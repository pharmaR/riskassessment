...
* Updated app_server to allow an admin working on development to supply a `pre_auth_user` 
option and `user_id` and `user_pwd` credentials to bypass the `login` screen.
