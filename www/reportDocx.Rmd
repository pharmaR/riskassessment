...
ggplot2::ggplot(data = d, ggplot2::aes(x = day_month_year, y = downloads)) +
  ggplot2::geom_point() +
  ggplot2::geom_line() +
  ggplot2::scale_x_date(date_breaks = glue::glue("{mo} months"), date_labels = "%m-%Y") +
  ggplot2::labs(
    x = 'Month/Year',
    y = 'Downloads'
  ) +
  ggplot2::theme(text = ggplot2::element_text(size = 16),
                 axis.text = ggplot2::element_text(size=16))# angle = 30, vjust = 0.5, hjust=1))
```
