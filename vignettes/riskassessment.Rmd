...
The fourth tab, `Administrative tools`, allows `ADMIN` users to add or delete users as well as change passwords for themselves or other users.  Details are provided in a “administrative tools”[insert link] guide
