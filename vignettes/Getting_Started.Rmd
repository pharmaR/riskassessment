...
This guide will help you get started using the `riskassessment` application for the first time. For more information about how to deploy the application, please reference the `Deployments` [INSERT LINK] guide. Please note, we'll assume you've already downloaded the `riskassessment` package & all of it's dependencies following the [installation instructions](../index.html#installation).

## First-time login

After you have [installed](../index.html#installation) the `riskassessment` package, you are now able to create the usual shiny `app.R` file, open it and insert:
