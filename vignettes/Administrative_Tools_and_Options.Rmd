...
Edit user information by clicking on the blue `r fa(name = "pen-to-square", fill = "blue", height = "2em")` <a style="color:blue">Edit</a> button, found on the right-hand side of the table.
...
A small modal will briefly appear indicated the user has been updated.
