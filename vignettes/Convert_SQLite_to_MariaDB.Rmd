...
create_db <- function(){
  ...
  con <-  DBI::dbConnect(RMariaDB::MariaDB(), user = db_user,
  ...
  if (rlang::is_empty(alltables)) {     # new line
  ...
  } # New line -- if (rlang::is_empty(alltables))
...
```{r, eval = FALSE}
 # con <- DBI::dbConnect(RSQLite::SQLite(), db_name)
  ...
  con <-  DBI::dbConnect(RMariaDB::MariaDB(), user = db_user, password = db_password,
                    dbname = db_name, host = db_host, port = db_port)
```
