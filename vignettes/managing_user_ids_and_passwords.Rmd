...
vignette: >
  %\VignetteIndexEntry{Managin User Ids and Passwords}
...
![](figures/create_keyring.png){width=400px style="margin: 10px 0 10px 0"}
...
![](figures/initial_authentication_page.png){width=400px style="margin: 10px 0 10px 0"}
...
![](figures/change_password.png){width=400px style="margin: 10px 0 10px 0"}
...
![](figures/admin_mode_button.png){width=750px style="margin: 10px 0 10px 0"}
...
![](figures/admin_mode_tables.png){width=750px}
...
![](figures/add_user_bar.png){width=750px}
...
![](figures/add_user.png){width=750px}
...
![](figures/account_expired_msg.png){width=400px}
...
![](figures/users_table.png){width=750px}
