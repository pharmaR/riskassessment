...
output:
  word_document:
    reference_docx: "D:/FL/Risk_Metrics/GitHub_Refactor-code/Code_Logo/A_Synchr/risk_assessment_app-refactor-code (25)/risk_assessment_app-refactor-code/Reports/rmarkdown_template.docx"
params:
  package: NA
  cwd: NA
---
...
```{r echo=FALSE}
 if (!identical(values$selected_pkg$decision, character(0)) && values$selected_pkg$decision != "") {
    HTML(paste("<br>", "<h5>Decision: ", "<b>", values$selected_pkg$decision, "</b></h5>"))
  } else{
