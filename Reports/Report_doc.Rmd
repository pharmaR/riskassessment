...
This **`r pkg_GenInfo$package`** package report was generated using  **`r input$select_ver`** riskmetric version .  Metrics were reviewed via the R Package Risk Assessment Application.</div>
