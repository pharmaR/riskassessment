...
<div class="report">This **`r pkg_GenInfo$package`** package report was generated using  **`r input$select_ver`** riskmetric version. Metrics were reviewed via the R Package Risk Assessment Application.</div>
...
```{r echo=FALSE}
 if (!identical(pkg_GenInfo$decision, character(0)) && pkg_GenInfo$decision != "") {
    HTML(paste("<br>", "<h5>Decision: ", "<b>", pkg_GenInfo$decision, "</b></h5>"))
  } else{
