...
subtitle: "Report of the `r params$package` R package"
...
if(nrow(comment_o) != 0) {
  ...
  <i class='fa fa-user-tie fa-2x d-inline'></i>
  <h3 class='ml-3 d-inline'><b class='user-name-color'>",
  comment_o$user_name,
  "(",
  comment_o$user_role,
  ")",
...
if(nrow(comment_mm) != 0) {
  ...
  HTML(paste(
    "<div class='col-md-12 comments-box'>
      <div class='col-sm-12 comment-border-bottom single-comment-div'>
      <i class='fa fa-user-tie fa-2x d-inline'></i>
      <h3 class='ml-3 d-inline'><b class='user-name-color'>",
