...
pkg_GenInfo <- dbSelect(paste0(
  "SELECT * FROM package WHERE name ='",
  params$package,
  "'"
))

package_id <- dbSelect(paste0(
...
riskmetrics_cum <- dbSelect(glue(
  "SELECT * FROM community_usage_metrics WHERE id ='{params$package}'"))
...
# metric_id <- dbSelect(paste0("SELECT id FROM metric WHERE name = 'covr_coverage';"))
# covr_coverage <- dbSelect(
...
comment_mm <- dbSelect(glue(
  ...
  FROM comments
  WHERE id = '{params$package}' AND comment_type = 'mm'"))  
...
comment_tm <- dbSelect(glue(
  "SELECT user_name, user_role, comment, added_on
  FROM comments
  WHERE id = '{params$package}' AND comment_type = 'tm'"))
